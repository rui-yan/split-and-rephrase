...
from eval_SARI import sari_hook
from eval_SARI import utils

import tensorflow as tf


def read_data(source_path, pred_path, reference_path, lowercase):
	...
	#with tf.io.gfile.GFile(pred_path) as f2:
	...
	with open(reference_path) as f3:
		for line in f3:
			targets= line.rstrip('\n').split('\t')
			if lowercase:
