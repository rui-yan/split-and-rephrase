...
def main():
    ...
    test_dirs_path_prefix = base_path + '/Split-and-Rephrase/evaluation-directories/websplit/test/'

    # the file containing the ids of the test sentences
    test_sent_ids_path = base_path + '/Split-and-Rephrase/benchmark/websplit/complex-sents/test.id'
